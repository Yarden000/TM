...
class Game:
    ...
    def run(self):
        ...
        while game_run:
            ...
            if keys[pygame.K_1]:
                angle = angle_between_vectors(VEC_2(100, 100), VEC_2(pygame.mouse.get_pos()) - VEC_2(WIDTH, HEIGHT) / 2)
                angle = angle_between_vectors(VEC_2(pygame.mouse.get_pos()) - VEC_2(WIDTH, HEIGHT) / 2, VEC_2(100, 100))
                print(angle)
